...
新申請、新建學生及帳戶 CSV 匯入使用：初中 1A–1E、2A–2E、3A–3E；高中 S4、S5、S6；外來學生 Other。CSV 的 other／OTHER 會統一為 Other。

既有 4A–6E 學生紀錄不會自動合併或更改 studentId，可繼續登入、設定角色及連結新電郵；新建不再接受這些舊高中班別。舊待審申請如選擇新建學生，老師須改選新班別；連結現有帳號仍可沿用其原有班別。

重複學生仍按「班別＋學號」判斷，因此同一高中年級或 Other 內的學號應保持唯一。不要把不同原班級中同號學生自動合併。本次班別變更須再部署網站及 Firestore 規則才會正式生效。
